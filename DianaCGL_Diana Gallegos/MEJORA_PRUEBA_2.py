...
class EvaluacionISO27001(tk.Tk):
    ...
    def solicitar_datos_generar_informe(self):
        ...
        self.nombre_compania = simpledialog.askstring("Nombre de la Compañía Auditora", "Ingrese el nombre de la compañía auditora:")
        self.nombre_compania_evaluada = simpledialog.askstring("Nombre de la Compañía Evaluada", "Ingrese el nombre de la compañía evaluada:")
        ...
        self.firma = simpledialog.askstring("Firma del Auditor", "Ingrese el nombre del auditor que firma la carta:")

        if not all([self.nombre_auditor, self.nombre_compania, self.nombre_compania_evaluada, self.fecha_evaluacion, self.destinatario, self.firma]):
    ...
    def generar_informe(self):
        ...
        generar_informe_word(calificaciones_input, promedios_ponderados, calificacion_final,
                             ...
                             self.nombre_compania_evaluada, self.destinatario, self.firma)
